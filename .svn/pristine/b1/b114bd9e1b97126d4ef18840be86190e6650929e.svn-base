...
public interface OrdersDao {
    ...
    List<Orders> selectOrderByMerchantUserId(@Param("merchantUserId")Long merchantUserId,@Param("outTradeNo")String outTradeNo);
    ...
    List<Orders> selectOrderByPhoneCallback(OrderQueryPara oqp);
    
    HashMap<String,Object> financeStatistics(String sql);
